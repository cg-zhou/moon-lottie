...
const MoonLottiePlayer = forwardRef(function MoonLottiePlayer(
  ...
  useImperativeHandle(ref, () => ({
    ...
    loadRemoteAnimation: (filename) => playerRef.current?.loadRemoteAnimation(filename),
    loadFile: (file) => playerRef.current?.loadFile(file),
    switchRuntime: (preference) => playerRef.current?.switchRuntime(preference),
    ...
    getRuntime: () => playerRef.current?.getRuntime(),
    getBackend: () => playerRef.current?.getBackend() ?? "uninitialized",
    getPreference: () => playerRef.current?.getPreference() ?? "auto",
    describePreference: (preference) => playerRef.current?.describePreference(preference) ?? preference,
  ...
  }, [src, path, animationData, name, renderer, rendererSettings, initialSegment, wasmPath, jsRuntimePath])
